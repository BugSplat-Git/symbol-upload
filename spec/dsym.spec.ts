    ...
    describe('getDSymFileInfos', () => {
        ...
        it('should return path, relativePath, dbgIds, module names for macho files', () => {
            return expectAsync(getDSymFileInfos('spec/support/bugsplat.app.dSYM')).toBeResolvedTo(jasmine.arrayContaining([
                {
                    path: jasmine.stringContaining('/symbol-upload/tmp/2dd1bd2706fa384da5a3a8265921cf9a/bugsplat.app.dSYM'),
                    relativePath: '2dd1bd2706fa384da5a3a8265921cf9a/bugsplat.app.dSYM',
                    dbgId: '2dd1bd2706fa384da5a3a8265921cf9a',
                    moduleName: 'bugsplat.app.dSYM',
                },
                {
                    path: jasmine.stringContaining('/Users/bobby/Desktop/bugsplat/symbol-upload/tmp/2ce192f6c5963e66b06aa22bde5756a0/bugsplat.app.dSYM'),
                    relativePath: '2ce192f6c5963e66b06aa22bde5756a0/bugsplat.app.dSYM',
